 ...
 * Use the {@link FragmentAyuda#newInstance} factory method to
...
public class FragmentAyuda extends Fragment {
     ...
     * @return A new instance of fragment FragmentAyuda.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        servicioayuda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FragmentManager fragmentManager = requireActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.fragment_container, new FragmentServicioAyuda());
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
            }
        });
